...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError>objectNotFound(DataIntegrityException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(HttpStatus.BAD_REQUEST.value(), e.getMessage(), System.currentTimeMillis()); //servidor não pode ou não irá processar a requisição 
